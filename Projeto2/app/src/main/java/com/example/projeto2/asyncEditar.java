...
public class asyncEditar extends AsyncTask<Void, Void,Informacao>
{
    private static String urlAlterarAluno      = "http://192.168.25.10:8080/WSRestServidor/webresources/generic/alterarAluno/";
    private static int ra;
    private static String nome;
    private static String emailAluno;

    public asyncEditar(Aluno a)
    {
        this.ra=a.getRa();
        this.nome = a.getNome();
    ...
    protected Informacao doInBackground(Void... voids)
    {
        ...
        {
            Informacao retorno = new Informacao("erro" + e.toString());
            return retorno;
        }
    }
